...
class TimerService {
  Future<bool> saveTimerSetting(int focusDuration, int restDuration) async {
    ...
    return preferences.setString(TimerConstant.TIMER_SETTING_NAME,
        jsonEncode(TimerModel(focus: focusDuration, rest: restDuration)));
  }
  ...
  Future<TimerModel> getTimerSetting() async {
    ...
    return (tempJson != null)
        ? TimerModel.fromJson(jsonDecode(tempJson))
        : null;
  }
}
